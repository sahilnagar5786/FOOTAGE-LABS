...
const Header = () => {
  ...
  return (
    <>
      <Button zIndex={"overlay"} pos={"fixed"} top={"4"} left={"4"} colorScheme={"purple"} w={"10"} p={"0"} h={"10"} borderRadius={"full"} onClick={onOpen} >
      ...
      <Drawer isOpen={isOpen} placement={"left"} onClose={onClose}>
        ...
        <DrawerContent>
          <DrawerCloseButton />
          <DrawerHeader>FOOTAGE-LABS</DrawerHeader>
          <DrawerBody>
            ...
            <HStack position={"absolute"} bottom={"10"} left={"0"} justifyContent={"space-evenly"} w={"full"}>
